...
{
    protected $rules = [
        'name' => 'required|name|unique:languages',
        'code' => 'required|code|unique:languages',
    ];
    public function listLanguage(){
        $languages = DB::table('languages')->get();
        return view('language-types', compact('languages'));
    }
    ...
    public function destroyLanguage($id){
        ...
        return redirect('admin/language-types');
    }
