...
use Theme;
use App\Repository\TravelTipRepository;
use App\Repository\TravelTipViewRepository;
...
class TravelTipController extends VoyagerBaseController
{
    ...
    public function __construct(
        ...
        TravelTipRepository $travelTipRepository,
        TravelTipViewRepository $travelTipViewRepository,
    ...
    {
        $dataAllLogView  = $this->travelTipViewRepository->listAllLogView();
        $alldata = $this->travelTipRepository->getAll();
        ...
        return view('travel-tip',compact('dataAllLogView'),$data);
    }

    public function detail($id){
        $this->travelTipViewRepository->addlogByViewPage($id);
        $dataAllSocial= $this->travelTipViewRepository->listAllLogById($id);
        $data = $this->travelTipRepository->getDataById($id);
        ...
        return view('travel-tip-detail',compact('data','dataAllSocial'));
    }
    ...
    {
        $type = 'facebook';
        $this->travelTipViewRepository->addlogByShareSocialPage($id,$type);
    ...
    private function addMappingLang($request){
        if(!empty($request->master_id)){
            $data =  $this->mappingLangRepository->getTitleLastInsertTravelTips($request->title);
            $dataArr = array(
                'master_id'=> $data->id,
