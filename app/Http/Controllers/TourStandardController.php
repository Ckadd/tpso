...
use Theme;
use App\Repository\TourStandardRepository;
use App\Repository\TourStandardViewRepository;
...
class TourStandardController extends VoyagerBaseController
{
    ...
    public function __construct(
        ...
        TourStandardRepository $tourStandardRepository,
        TourStandardViewRepository $tourStandardViewRepository,
    ...
    {
        $dataAllLogView  = $this->tourStandardViewRepository->listAllLogView();
        $alldata = $this->tourStandardRepository->getAll();
        ...
        return view('tour-standards',compact('dataAllLogView'),$data);
    }

    public function detail($id){
        $this->tourStandardViewRepository->addlogByViewPage($id);
        $dataAllSocial= $this->tourStandardViewRepository->listAllLogById($id);
        $data = $this->tourStandardRepository->getDataById($id);
        ...
        return view('tour-standards-detail',compact('data','dataAllSocial'));
    ...
    {
        $type = 'facebook';
        $this->tourStandardViewRepository->addlogByShareSocialPage($id,$type);
    ...
    private function addMappingLang($request){
        if(!empty($request->master_id)){
            $data =  $this->mappingLangRepository->getTitleLastInsertTourStandards($request->title);
            $dataArr = array(
                'master_id'=> $data->id,
                'parent_id'=>$request->master_id,
                'code_lang'=>$request->_lang,
                'module'=>'tour-standards',
