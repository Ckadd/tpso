...
use Theme;
use App\Repository\StrategicRepository;
...
class StrategicController extends VoyagerBaseController
{
    ...
    public function __construct(
        ...
        StrategicRepository $strategicRepository,
    ...
    {
        $data = $this->strategicRepository->listData();
