...
use Theme;
use App\Repository\OrganizationalStructureRepository;
...
class OrganizationalStructureController extends VoyagerBaseController
{
    protected $themeService;
    protected $organizationalStructureRepository;
    protected $auditLogRepository;
    protected $visitorLogsRepository;

    public function __construct(
        ThemeService $themeService,
        OrganizationalStructureRepository  $organizationalStructureRepository,
    ...
    {
        $data = $this->organizationalStructureRepository->listData();
        ...
        return view('organizational-structures',$data);   
    }
