                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        @endforeach
                                        <th>{{ __('voyager::generic.send_news') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endforeach
                                        <td>
                                            <button class="btn btn-success btnconfirm" data-mail="{{$data->email}}" >Send Newsletter</button>
                                        </td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="newletteremail" value="">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" id="modal-confirm" data-url="{{route('newsletter.subscribe.ByEmail')}}" class="btn btn-primary">Ok</button>
      </div>
    </div>
  </div>
</div>
    ...
    <script>
        $(document).ready(function(){
            $(".btnconfirm").click(function(){
                var emailById = $(this).data('mail');
                $('input[name="newletteremail"]').val(emailById);
                $("#modal-newletter-confirm").modal('show');
            });

            $("#modal-confirm").click(function(){
                var url = $(this).data('url');
                var mail = $('input[name="newletteremail"]').val();
                console.log(url);
                $.ajax({
                    type:'GET',
                    url:url,
